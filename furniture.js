...
export const FURNITURE_TYPES = [
  ...
  { id: 'sofa',     label: 'ソファ',     icon: '🛋️', color: '#e8d5b8', defaultW: 3, defaultH: 1, minW: 2, minH: 1 },
  { id: 'lowtable', label: 'ローテーブル', icon: '🟫', color: '#e8d5a8', defaultW: 2, defaultH: 1, minW: 1, minH: 1 },
